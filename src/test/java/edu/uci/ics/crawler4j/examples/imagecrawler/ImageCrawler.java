...
public class ImageCrawler extends WebCrawler {
    ...
    public void visit(Page page) {
        ...
        String path = storageFolder.getAbsolutePath() + "/" + folder2 + "/" + folder1;
        String fname = storageFolder.getAbsolutePath() + "/" + folder2 + "/" + folder1 + "/" + iname;
    //    System.out.println("----------" + path);
        ...
        try {
            ...
            Files.write(page.getContentData(), new File(fname));
